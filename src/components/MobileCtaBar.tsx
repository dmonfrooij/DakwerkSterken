...
const MobileCtaBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 flex md:hidden border-t border-gray-200 bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.08)]">
      <a
        href="tel:0613027782"
        onClick={() =>
          trackEvent("contact_click", { method: "phone", location: "mobile_cta_bar" })
        }
        className="flex flex-1 items-center justify-center gap-2 py-3 text-blue-800 font-semibold text-sm"
      >
